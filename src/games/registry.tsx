...
export const GAMES: readonly GameDefinition[] = [
  ...
  },
  {
    ...
    turnType: '턴제',
    playerCount: 2,
    desc: '9장 중 폭탄 1장을 피하고, 규칙을 캐서 폭탄 위치를 정확히 지목하면 승리.',
    version: 'v1.1.0',
    updateDate: '2026-07-07',
    thumbKind: 'mosun',
    ...
    guide: {
      title: '코드네임 · 모순 가이드',
      steps: [
        { title: '한 줄 요약', desc: '뒤집힌 9장 중 폭탄 1장을 피하고, 정확히 찾아내면 승리.' },
        { title: '카드 구성 (9장)', desc: '💣 폭탄 1 · 📢 전체규칙 3 · 🔒 개인규칙 3 · ✓ 일반 2. 폭탄만 위험.' },
        { title: '전체규칙 · 개인규칙', desc: '전체는 양쪽 다 정보 획득. 개인은 연 사람만 알고, 상대는 "먹었다"만 봄.' },
        { title: '내 턴 · 세 가지 중 하나', desc: '🔄 뒤집기 / ⏭ 턴 넘기기(게임당 1회) / 🎯 폭탄 찾기(지목 → 맞으면 승리, 틀리면 패배).' },
        { title: '핵심 감각', desc: '규칙만으로 폭탄 확정 불가. 후보는 늘 2칸 이상 남음. 끝은 판단과 배짱.' },
      ],
    },
  },
  {
