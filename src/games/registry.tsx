...
export const GAMES: readonly GameDefinition[] = [
  ...
  },
  {
    ...
    guide: {
      title: '냥탈출 가이드',
      oneLine: '두 사람이 좁은 시야의 미로에서 서로 합류하고 열쇠를 찾아, 나타난 출구로 함께 탈출하는 협동 게임입니다.',
      sections: [
        {
          title: '출구 조건 (순서 무관)',
          kind: 'rows',
      ...
      steps: [
        ...
        { title: '아이템 정책', desc: '시야·속도 아이템은 한 번 먹으면 라운드 끝까지 유지되고, 여러 번 먹을수록 x2·x3처럼 누적돼요.' },
        { title: '승리 조건', desc: '두 사람이 합류 + 열쇠 획득을 모두 만족하면 출구가 나타나요. 아무나 출구를 밟으면 팀 성공, 5분 초과 시 실패.' },
      ],
      warning: {
        text: '아무도 미로 전체를 못 봐요. 우측 상단 미니맵은 내 위치만 알려주고 벽은 표시하지 않아요. 소통이 곧 실력.',
        tone: 'accent',
      },
    },
  },
